...
/* ═══════════════════════════════════════════════════════════════════════
   ...
   //Customer with account, Orders are tracked. Upon checkout, order number is added to the 'customer' table in colum 'past_orders'. Orders are stored as a comma seperated list of order numbers.
   //  Past 3 orders are listed in the bottom left corner. Rebuy button appears when a past order is clicked. On click and the order is populated. 
   //Upon purchase, past_orders is updated. 
